    ...
    class Student
    {
        ...
        public static void SelectCourse()
        {
            ...
            for (int i = 0; i < Course.courseList.Count; i++)
            {
                ...
                Console.WriteLine("\nYou are now enrolling students in: " + Course.courseList[i].GetTitle() + "\n");
                ...
                do
                {
                    ...
                    for (int j = 0; j < Student.studentList.Count; j++)
                    {
                        if ((optionStudent - 1) == j)
                        {
                            ...
                            Console.WriteLine("\nSuccessfully added " + Student.studentList[j].GetFullName() + " to " + Course.courseList[i].GetTitle());
                        }
                    ...
                    do
                    {
                        Console.WriteLine("\nDo you want to enroll another student to this subject? Y/N");
