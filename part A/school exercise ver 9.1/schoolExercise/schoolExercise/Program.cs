...
namespace schoolExercise
{
    ...
    class Data
    {
        ...
        public List<AssignmentTwnCoursesTwnStudents> AssignmentsTwnCoursesTwnStudents { get; set; } = new List<AssignmentTwnCoursesTwnStudents>();
        ...
        public Data()
        {
            ...
            AssignmentTwnCoursesTwnStudents ACS1 = new AssignmentTwnCoursesTwnStudents(courPerStu1, S1Assign);
            AssignmentsTwnCoursesTwnStudents.Add(ACS1);


        }

        public void PrintDokimi()
        {
            Console.WriteLine("-------------------");
        ...
        public void PrintDokimi2()
        {
            foreach (var item in AssignmentsTwnCoursesTwnStudents)
            {
                item.Output();
            }
        }
    ...
    class AssignmentTwnCoursesTwnStudents
    {
        CoursePerStudent CoursePerStudent { get; set; }

        public AssignmentTwnCoursesTwnStudents(CoursePerStudent courseperstudent, List<Assignment> assignments)
        {
            CoursePerStudent = courseperstudent;
            courseperstudent.Assignments = assignments;
        }

        public void Output()
        {
            foreach (var item in CoursePerStudent.Assignments)
            {
                Console.Write("\t");
                item.Output();
            }
