...
namespace schoolExercise
{
    ...
    class Data
    {
        ...
        public Data()
        {
            ...
            Assignment a3 = new Assignment("Project Library", Convert.ToDateTime("2020-02-01"));
            Assignment a4 = new Assignment("Project Lab", Convert.ToDateTime("2020-12-21"));
            Assignment a5 = new Assignment("Project School", Convert.ToDateTime("2020-06-14"));
        ...
        public void PrintAssignmentsPerStudentDate()
        {
