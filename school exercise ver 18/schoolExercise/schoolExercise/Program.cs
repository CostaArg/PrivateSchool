...
namespace schoolExercise
{
    ...
    class Data
    {
        ...
        public Data()
        {
            ...
            //Assignment a6 = new Assignment("Project Architecture", "Blueprint making software", new DateTime(2020, 3, 24));
        ...
        public void PrintStudentsWithDueDate()
        {
            ...
            //    correctDate = new DateTime(2020, 10, 3);
            //}

            Console.WriteLine("Enter date yyyy-mm-dd : ");
            DateTime correctDate = Convert.ToDateTime(Console.ReadLine());
